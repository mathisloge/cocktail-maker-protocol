...
#include "proto/factory/AllMessagesDynMemMsgFactory.h"
...
struct AllMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using MsgFactory =
        proto::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
